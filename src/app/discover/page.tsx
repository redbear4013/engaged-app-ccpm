...
import { NearbyEvents } from '@/components/sections/NearbyEvents';
...
export const metadata: Metadata = {
  ...
  description: 'Discover trending, nearby, and top-rated events in Macau, Hong Kong, and the Greater Bay Area. Find your perfect event match with AI-powered recommendations.',
  keywords: [
    'events',
    'discover',
    'trending',
  ...
  openGraph: {
    title: 'Discover Events - Engaged',
    description: 'Discover trending, nearby, and top-rated events in Macau, Hong Kong, and the Greater Bay Area.',
    type: 'website',
  },
};
